...
namespace CodeM.Common.Orm.Serialize
{
    ...
    public class ModelMetaObject : DynamicMetaObject
    {
        ...
        public ModelMetaObject(Expression expression, BindingRestrictions restrictions, object value) : 
            base(expression, restrictions, value)
        {
            mValue = (ModelObject)value;
        }
        ...
        public override DynamicMetaObject BindSetMember(SetMemberBinder binder, DynamicMetaObject value)
        {
            ...
            Expression methodCall = Expression.Call(self, typeof(ModelObject).GetMethod(methodName), args);
