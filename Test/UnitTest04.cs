...
namespace UnitTest
{
    ...
    public class UnitTest04
    {
        ...
        public void Test3()
        {
            List<dynamic> result = Derd.Model("user").GetValue("name", "age").Equals("name", "wangxm").Query();
        ...
        public void Test5()
        {
            List<dynamic> result = Derd.Model("User").In("Name", "wangxm", "huxinyue").Query();
            Assert.AreEqual(result.Count, 2);
            List<dynamic> result2 = Derd.Model("User").In("Name", "").Query();
        ...
        public void Test6()
        {
            List<dynamic> result = Derd.Model("User").Equals("Name", "huxinyue").Top(1).Query();
        ...
        public void Test7()
        {
            List<dynamic> result = Derd.Model("User").Gt("age", 11).Query();
            Assert.AreEqual(result.Count, 1);
        }
        ...
        public void Test8()
        {
            List<dynamic> result = Derd.Model("User").Gte("age", 11).Query();
            Assert.AreEqual(result.Count, 2);
        }
        ...
        public void Test9()
        {
            List<dynamic> result = Derd.Model("User").Lt("age", 18).Query();
            Assert.AreEqual(result.Count, 1);
        }
        ...
        public void Test10()
        {
            List<dynamic> result = Derd.Model("User").Lte("age", 18).Query();
            Assert.AreEqual(result.Count, 2);
        }
        ...
        public void Test11()
        {
            List<dynamic> result = Derd.Model("User").Like("name", "%x%").Query();
            Assert.AreEqual(result.Count, 2);
        }
        ...
        public void Test12()
        {
            List<dynamic> result = Derd.Model("User").Like("name", "wang%").Query();
            Assert.AreEqual(result.Count, 1);
        }
        ...
        public void Test13()
        {
            List<dynamic> result = Derd.Model("User").IsNull("name").Query();
        ...
        public void Test14()
        {
            List<dynamic> result = Derd.Model("User").IsNotNull("name").Query();
            Assert.AreEqual(result.Count, 2);
        }
        ...
        public void Test15()
        {
            List<dynamic> result = Derd.Model("User").Between("age", 17, 19).Query();
        ...
        public void Test16()
        {
            List<dynamic> result = Derd.Model("user").Top(1).AscendingSort("Name").Query();
        ...
        public void Test17()
        {
            List<dynamic> result = Derd.Model("user").Top(1).DescendingSort("Name").Query();
        ...
        public void Test18()
        {
            List<dynamic> result = Derd.Model("user").PageSize(1).PageIndex(1).Query();
            Assert.AreEqual(result.Count, 1);
        }
        ...
        {
            List<dynamic> result = Derd.Model("user").PageSize(1).PageIndex(1).Query();
            List<dynamic> result2 = Derd.Model("user").Top(1).Query();
