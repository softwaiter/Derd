...
```shell
Install-Package CodeM.Common.Orm -Version 1.8.1
```
...
```shell
dotnet add package CodeM.Common.Orm --version 1.8.1
```
...
```xml
<PackageReference Include="CodeM.Common.Orm" Version="1.8.1" />
```
...
```shell
paket add CodeM.Common.Orm --version 1.8.1
```
