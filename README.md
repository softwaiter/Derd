...
```shell
Install-Package CodeM.Common.Orm -Version 1.8.2
```
...
```shell
dotnet add package CodeM.Common.Orm --version 1.8.2
```
...
```xml
<PackageReference Include="CodeM.Common.Orm" Version="1.8.2" />
```
...
```shell
paket add CodeM.Common.Orm --version 1.8.2
```
